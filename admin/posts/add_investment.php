...
<head>
    ...
    <title>Admin Section- Add Invesment</title>
    <!-- linking css file to html code -->
    <link rel="stylesheet" href="../../views/css/style.css"> 
    <link rel="stylesheet" href="../posts/admin.css"> 
    <link rel="stylesheet" href="../posts/add.css"> 
       ...
       <!-- admin page admin-wrapper -->
        <div class="admin-wrapper">
            ...
            <div class="admin-content">
                    <h2 class="page-title">Add Investment</h2>
                    <form id="investment" class="input-group-form" action="../../actions/ainvestment.php" method="post">
                        <div class="form-group">
                        <label>Type of Investor</label>
                            <input type="text" class="form-control" name="investor" id="investor" required>
                        </div>
                        <div class="form-group">
                        <label>Type of Investment</label>
                            <input type="text" class="form-control" name="itype" id="itype" required>
                        </div>
